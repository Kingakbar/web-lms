...
@section('title', 'Edit Quiz - Instructor Dashboard')
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="page-header-modern">
            <div class="page-title-group">
                <h2>Edit Quiz</h2>
                <p class="page-subtitle">Perbarui quiz dan soal-soal yang sudah ada</p>
            </div>
            <div>
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <p class="form-subtitle">Perbarui informasi quiz dan pertanyaan dengan lengkap</p>
            </div>
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <textarea name="description" id="description" rows="3"
                                class="input-modern @error('description') input-error @enderror">{{ old('description', $quiz->description) }}</textarea>
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="number" name="passing_score" id="passing_score" min="0" max="100"
                                class="input-modern @error('passing_score') input-error @enderror"
                        ...
                        <div id="questions-wrapper">
                            @foreach ($quiz->questions as $i => $q)
                                <div class="card border-0 shadow-sm p-3 mb-3 question-item" style="border-radius:12px;">
                                    <input type="hidden" name="questions[{{ $i }}][id]"
                                        value="{{ $q->id }}">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="fw-bold text-dark mb-0">Pertanyaan {{ $i + 1 }}</h6>
                                    ...
                                    <div class="input-group-modern mb-2">
                                        ...
                                        <input type="text" name="questions[{{ $i }}][question]"
                                            class="input-modern" value="{{ $q->question }}">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <input type="text" name="questions[{{ $i }}][option_a]"
                                                class="input-modern" value="{{ $q->option_a }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <input type="text" name="questions[{{ $i }}][option_b]"
                                                class="input-modern" value="{{ $q->option_b }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <input type="text" name="questions[{{ $i }}][option_c]"
                                                class="input-modern" value="{{ $q->option_c }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <input type="text" name="questions[{{ $i }}][option_d]"
                                                class="input-modern" value="{{ $q->option_d }}">
                                        </div>
                                    </div>
                                    <div class="input-group-modern">
                                        ...
                                        <select name="questions[{{ $i }}][correct_answer]"
                                            ...
                                            <option value="A" {{ $q->correct_answer == 'A' ? 'selected' : '' }}>Opsi
                                                A</option>
                                            <option value="B" {{ $q->correct_answer == 'B' ? 'selected' : '' }}>Opsi
                                                B</option>
                                            <option value="C" {{ $q->correct_answer == 'C' ? 'selected' : '' }}>Opsi
                                                C</option>
                                            <option value="D" {{ $q->correct_answer == 'D' ? 'selected' : '' }}>Opsi
                                                D</option>
                                        </select>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <div class="card border-0 shadow-sm p-3 mb-3 question-item" style="border-radius:12px;">
                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <input type="text" name="questions[${questionIndex}][option_a]" class="input-modern" placeholder="Opsi A">
                    </div>
                    <div class="col-md-6 mb-2">
                        <input type="text" name="questions[${questionIndex}][option_b]" class="input-modern" placeholder="Opsi B">
                    </div>
                    <div class="col-md-6 mb-2">
                        <input type="text" name="questions[${questionIndex}][option_c]" class="input-modern" placeholder="Opsi C">
                    </div>
                    <div class="col-md-6 mb-2">
                        <input type="text" name="questions[${questionIndex}][option_d]" class="input-modern" placeholder="Opsi D">
                    </div>
                </div>
                <div class="input-group-modern">
                    <label>Jawaban Benar</label>
