    ...
    <div class="container-fluid px-4">
        ...
        <div class="page-header-modern">
            <div class="page-title-group">
                <h2>Tambah Kursus</h2>
                <p class="page-subtitle">Buat kursus baru untuk ditampilkan ke peserta</p>
            </div>
            <div>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                ...
                <p class="form-subtitle">Isi informasi kursus dengan lengkap dan benar</p>
            </div>

            <!-- Form Body -->
            <div class="form-body">
                <form action="{{ route('courses_instructor.store') }}" method="POST" enctype="multipart/form-data"
                    id="courseForm">
                    @csrf
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Masukkan judul kursus" value="{{ old('title') }}" required autocomplete="off">
                    ...
                    <div class="input-group-modern">
                        ...
                        <small class="form-text text-muted mt-2">
                            ...
                            Slug akan dibuat otomatis dari judul, atau Anda bisa mengisi manual
                        </small>
                    </div>
                    ...
                    <div class="input-group-modern">
                        ...
                        <textarea name="description" id="description" rows="5"
                            class="input-modern @error('description') input-error @enderror" placeholder="Tulis deskripsi kursus">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="number" name="price" id="price"
                                ...
                                placeholder="Masukkan harga kursus" value="{{ old('price') }}">
            ...
            <div class="card border-0 shadow-sm"
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-2">
                            <i class="bi bi-check-circle text-success me-2"></i>
                            Pilih kategori yang sesuai dengan konten kursus
                        </li>
                        <li class="mb-0">
                            <i class="bi bi-check-circle text-success me-2"></i>
                            Deskripsi yang lengkap membantu menarik lebih banyak peserta
                        </li>
                    </ul>
                </div>
            </div>
