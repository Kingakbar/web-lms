    ...
    <div class="container-fluid px-4">
        ...
        <div class="page-header-modern">
            <div class="page-title-group">
                <h2>Tambah Promo</h2>
                <p class="page-subtitle">Buat promo baru untuk menarik lebih banyak pelanggan</p>
            </div>
            <div>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                ...
                <p class="form-subtitle">Isi detail promo dengan lengkap dan benar</p>
            </div>

            <!-- Form Body -->
            <div class="form-body">
                <form action="{{ route('promos.store') }}" method="POST" id="promoForm">
                    @csrf
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Contoh: Diskon Awal Tahun" value="{{ old('title') }}" required>
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="number" name="discount_percentage" id="discount_percentage"
                                ...
                                placeholder="Contoh: 25" value="{{ old('discount_percentage') }}" min="0"
                                max="100">
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="number" name="discount_amount" id="discount_amount"
                                ...
                                placeholder="Contoh: 50000" value="{{ old('discount_amount') }}" min="0">
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-with-icon">
                            <input type="date" name="end_date" id="end_date"
                                class="input-modern @error('end_date') input-error @enderror" value="{{ old('end_date') }}"
                                required>
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            ...
                            Gunakan kode promo yang singkat & mudah diingat
                        </li>
                        <li class="mb-2">
                            <i class="bi bi-check-circle text-success me-2"></i>
                            Pastikan promo memiliki batas waktu yang jelas
                        </li>
                        <li class="mb-0">
                            <i class="bi bi-check-circle text-success me-2"></i>
                            Pilih salah satu: diskon persen atau diskon nominal
                        </li>
                    </ul>
                </div>
            </div>
