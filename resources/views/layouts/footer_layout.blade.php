<section class="cta section-padding">
    <div class="container text-center" data-aos="fade-up">
        <h2>Siap Memulai Perjalanan Tech Career Anda?</h2>
        <p>Bergabunglah dengan 50,000+ siswa yang telah mempercayai Technest Academy untuk mengembangkan karir
            teknologi mereka.</p>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="d-flex align-items-center mb-3">
                    <img src="{{ asset('assets/img/logo.png') }}" alt="Technest Academy Logo" class="me-2"
                        style="width: 50px; height: 50px;">
                    <h5 class="mb-0 text-white">Technest Academy</h5>
                </div>
                <p class="text-light mb-4">
                    Platform pembelajaran online terdepan untuk mengembangkan keahlian
                    dan membangun karir impianmu.
                </p>
            ...
            <div class="col-lg-2 col-6">
                <h6 class="text-white mb-3">Kursus</h6>
                <ul class="list-unstyled footer-links">
                    ...
                    <li class="mb-2"><a href="#">Cybersecurity</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 col-6">
                ...
                <ul class="list-unstyled footer-links">
                    ...
                    <li class="mb-2"><a href="#">Partner</a></li>
                </ul>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="text-light mb-0">&copy; 2025 Technest Academy. All rights reserved.</p>
            </div>
